...
class AuditLogManager(models.Manager):
    ...
    def failed_logins(self, hours=24):
        ...
        return self.filter(action=AuditAction.LOGIN_FAILED, timestamp__gte=since)
...
class AuditLog(models.Model):
    ...
    resource_id = models.UUIDField(
        null=True, blank=True, help_text="ID of the affected resource"
    )
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(
                fields=["organization", "timestamp"], name="audit_org_time_idx"
            ),
            ...
            models.Index(
                fields=["success", "timestamp"], name="audit_success_time_idx"
            ),
            models.Index(
