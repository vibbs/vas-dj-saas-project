...
class TestOrganizationAccessPermission:
    ...
    def test_permission_granted_when_user_belongs_to_organization(
        self, organization, user_with_org
    ):
    ...
    def test_permission_denied_when_user_belongs_to_different_organization(
        self, organization
    ):
    ...
    def test_edge_case_user_organization_comparison_with_same_object(
        self, organization
    ):
