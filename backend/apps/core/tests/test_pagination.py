...
from apps.core.pagination import StandardPagination, CustomPaginationClass
...
class TestStandardPagination:
    ...
    def test_get_paginated_response_schema(self):
        ...
        required_pagination_fields = [
            'count', 'totalPages', 'currentPage', 'pageSize'
        ]
...
class TestPaginationIntegration:
    ...
    def test_pagination_math_edge_cases(self):
        ...
        for count, page_size, expected_pages in test_cases:
            ...
            with patch.object(pagination, 'get_page_size') as mock_get_page_size:
                ...
                assert actual_pages == expected_pages, f"Count: {count}, Page size: {page_size}, Expected: {expected_pages}, Got: {actual_pages}"
    ...
    def test_pagination_configuration_attributes(self):
        ...
        assert hasattr(legacy_pagination, 'max_page_size')  # Inherits from DRF base class