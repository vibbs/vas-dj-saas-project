...
from apps.core.managers import OrganizationManager, TenantAwareQuerySet, TenantAwareManager
...
class TestOrganizationManager:
    ...
    def test_for_user_organizations_with_authenticated_user(self, user_with_org, organization_factory):
        ...
        with patch('apps.organizations.models.OrganizationMembership.objects.filter') as mock_filter:
            ...
            mock_membership_qs.values_list.assert_called_once_with('organization_id', flat=True)
    ...
    def test_create_for_organization_with_organization_instance(self, organization_factory):
...
class TestTenantAwareManager:
    ...
    def test_manager_preserves_organization_methods(self, user_with_org, organization_factory):
