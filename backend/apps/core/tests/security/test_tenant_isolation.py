...
class TestTenantIsolation:
    ...
    def setup_method(self):
        ...
        self.membership1 = OrganizationMembershipFactory(
            user=self.user1, organization=self.org1, role="member", status="active"
        )
        self.membership2 = OrganizationMembershipFactory(
            user=self.user2, organization=self.org2, role="member", status="active"
        )
    ...
    def test_superuser_can_access_all_data(self):
        ...
        superuser = AccountFactory(
            email="admin@system.com", is_superuser=True, is_staff=True
        )
    ...
    def test_multi_org_user_sees_data_from_all_their_orgs(self):
        ...
        OrganizationMembershipFactory(
            user=multi_org_user, organization=self.org1, role="member", status="active"
        )
        OrganizationMembershipFactory(
            user=multi_org_user, organization=self.org2, role="member", status="active"
        )
