...
from apps.core.responses import accepted, created, no_content, ok, success_response
...
class TestSuccessResponseHelper:
    ...
    def test_success_response_with_none_data(self):
        ...
        response = success_response(
            data=None, code="VDJ-EMPTY-200", i18n_key="empty.response"
        )
    ...
    def test_success_response_with_empty_data_structures(self):
        ...
        empty_data_cases = [{}, [], "", False, 0]

        for empty_data in empty_data_cases:
            response = success_response(
                data=empty_data, code="VDJ-EMPTY-200", i18n_key="empty.response"
            )
    ...
    def test_success_response_with_complex_data(self):
        ...
        response = success_response(
            data=complex_data, code="VDJ-USERS-LIST-200", i18n_key="users.list"
        )
...
class TestOkResponseHelper:
    ...
    def test_ok_with_custom_code(self):
        ...
        response = ok(data={"result": "success"}, code="VDJ-CUSTOM-OK-200")
    ...
    def test_ok_with_custom_i18n_key(self):
        ...
        response = ok(data={"result": "success"}, i18n_key="custom.success")
    ...
    def test_ok_with_all_parameters(self):
        ...
        response = ok(
            data=test_data, code="VDJ-ITEMS-LIST-200", i18n_key="items.listed"
        )
...
class TestCreatedResponseHelper:
    ...
    def test_created_with_custom_code(self):
        ...
        response = created(data={"id": 456}, code="VDJ-USER-CREATED-201")
    ...
    def test_created_with_custom_i18n_key(self):
        ...
        response = created(data={"id": 789}, i18n_key="user.created")
...
class TestAcceptedResponseHelper:
    ...
    def test_accepted_basic_structure(self):
        ...
        response = accepted(
            code="VDJ-TASK-ACCEPTED-202", data={"task_id": "task_12345"}
        )
...
class TestNoContentResponseHelper:
    ...
    def test_no_content_basic_structure(self):
        ...
        response = no_content(code="VDJ-DELETED-204", i18n_key="resource.deleted")
...
class TestResponseHelpersEdgeCases:
    ...
    def test_response_helpers_with_empty_strings(self):
        ...
        response = ok(
            data={"message": ""},
            code="",
            i18n_key="",  # Empty code  # Empty i18n key
        )
    ...
    def test_response_helpers_parameter_validation(self):
        ...
        for test_data in test_data_types:
            response = ok(data=test_data, code="VDJ-TEST-200", i18n_key="test.response")
    ...
    def test_success_response_code_type_handling(self):
        ...
        # Test with string
        response = success_response(data={}, code="VDJ-STRING-200", i18n_key="test")
        ...
        response = success_response(data={}, code=mock_enum, i18n_key="test")
        ...
        response = success_response(data={}, code=CustomCode(), i18n_key="test")
    ...
    def test_large_data_handling(self):
        ...
        response = ok(
            data=large_data, code="VDJ-LARGE-DATA-200", i18n_key="large.data.success"
        )
