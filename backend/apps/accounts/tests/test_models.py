...
from apps.accounts.enums import UserStatusTypes, UserRoleTypes
...
class TestAccountAuthProvider:
    ...
    def test_provider_user_id_uniqueness(self):
        ...
        provider1 = AccountAuthProviderFactory(provider='google', provider_user_id='12345')
    ...
    def test_multiple_providers_same_user(self):
        ...
        email_provider = AccountAuthProviderFactory(user=user, provider='email', is_primary=True)
