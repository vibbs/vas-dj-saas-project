...
class TestOrganizationViewSet:
    ...
    def test_stats_endpoint_data_accuracy(self, mock_objects, api_client, organization_with_owner):
...
class TestOrganizationAPIEdgeCases:
    ...
    def test_get_nonexistent_organization(self, api_client, authenticated_user):
        ...
        url = reverse('organization-detail', kwargs={'pk': '00000000-0000-0000-0000-000000000000'})
        response = api_client.get(url)
    ...
    def test_invalid_organization_data_update(self, api_client, organization_with_owner):
