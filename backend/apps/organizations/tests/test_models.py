...
class TestOrganizationModel:
    ...
    def test_plan_trial_consistency_validation(self):
        ...
        org = OrganizationFactory.build(on_trial=True, plan="pro")
    ...
    def test_is_trial_expired(self):
        ...
        with freeze_time("2024-01-15"):
            ...
            org4 = OrganizationFactory(
                plan="free_trial", on_trial=True, trial_ends_on=None
            )
...
class TestOrganizationMembership:
    ...
    def test_member_permissions(self):
        ...
        assert (
            not admin_membership.can_manage_billing()
        )  # Fixed: admins can't manage billing
