...
class TestFeatureFlagModel:
    ...
    def test_is_in_rollout_percentage_distribution(self):
        ...
        included_count = sum(
            ...
            if flag.is_in_rollout_percentage(user_id)
        )
...
class TestUserOnboardingProgressModel:
    ...
    def test_has_completed_stage(self, user):
        ...
        assert progress.has_completed_stage(OnboardingStageTypes.EMAIL_VERIFIED.value) is True
        assert progress.has_completed_stage(OnboardingStageTypes.PROFILE_SETUP.value) is True  # Current stage
        assert progress.has_completed_stage(OnboardingStageTypes.ORGANIZATION_CREATED.value) is False
    ...
    def test_get_available_features_advanced(self, user):
        ...
        features = progress.get_available_features()
        expected_features = [
            'basic_dashboard', 'profile_customization', 'team_features',
            'collaboration_tools', 'project_management', 'advanced_analytics'
        ]
