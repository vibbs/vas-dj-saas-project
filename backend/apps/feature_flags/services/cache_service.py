...
class FeatureFlagCacheService:
    ...
    @classmethod
    def get_user_flags_key(
        cls, user_id: str, organization_id: str | None = None
    ) -> str:
    ...
    def get_user_flags(
        ...
        try:
            ...
            if cached_data:
                ...
                logger.debug(
                    f"Retrieved cached flags for {user_id}: {len(data['flags'])} flags"
                )
                return data["flags"]
    ...
    @classmethod
    def cache_flag_metadata(
        cls, flag_key: str, metadata: dict[str, Any], timeout: int | None = None
    ) -> None:
        """
        ...
        try:
            ...
            cache_data = {"metadata": metadata, "cached_at": timezone.now().isoformat()}
    ...
    @classmethod
    def get_flag_metadata(cls, flag_key: str) -> dict[str, Any] | None:
        """
        ...
        try:
            ...
            logger.error(
                f"Failed to retrieve cached metadata for flag {flag_key}: {str(e)}"
            )
            return None

    @classmethod
    def cache_access_rules(
        cls, flag_key: str, rules: list[dict[str, Any]], timeout: int | None = None
    ) -> None:
        """
        ...
        try:
            ...
            cache_data = {"rules": rules, "cached_at": timezone.now().isoformat()}
    ...
    @classmethod
    def get_access_rules(cls, flag_key: str) -> list[dict[str, Any]] | None:
        """
        ...
        try:
            ...
            logger.error(
                f"Failed to retrieve cached access rules for flag {flag_key}: {str(e)}"
            )
            return None

    @classmethod
    def cache_onboarding_progress(
        cls, user_id: str, progress_data: dict[str, Any], timeout: int | None = None
    ) -> None:
        """
    ...
    @classmethod
    def get_onboarding_progress(cls, user_id: str) -> dict[str, Any] | None:
        """
        ...
        try:
            ...
            logger.error(
                f"Failed to retrieve cached onboarding progress for {user_id}: {str(e)}"
            )
            return None

    @classmethod
    def invalidate_user_flags(
        cls, user_id: str, organization_id: str | None = None
    ) -> None:
        """
        ...
        try:
            ...
            logger.error(
                f"Failed to invalidate cached flags for user {user_id}: {str(e)}"
            )
    ...
    def invalidate_flag_metadata(cls, flag_key: str) -> None:
        ...
        try:
            ...
            logger.error(
                f"Failed to invalidate cached metadata for flag {flag_key}: {str(e)}"
            )
    ...
    def invalidate_access_rules(cls, flag_key: str) -> None:
        ...
        try:
            ...
            logger.error(
                f"Failed to invalidate cached access rules for flag {flag_key}: {str(e)}"
            )
    ...
    def invalidate_onboarding_progress(cls, user_id: str) -> None:
        ...
        try:
            ...
            logger.error(
                f"Failed to invalidate cached onboarding progress for user {user_id}: {str(e)}"
            )
    ...
    def invalidate_all_flag_caches(cls, flag_key: str) -> None:
        ...
        try:
            ...
            logger.error(
                f"Failed to invalidate rollout cache for flag {flag_key}: {str(e)}"
            )
