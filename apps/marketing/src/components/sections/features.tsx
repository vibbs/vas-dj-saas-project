          ...
          {contentConfig.features.items.map((feature, index) => (
            <div key={index} className="group">
              <Link href={feature.href} className="block">
                <div className="bg-muted/50 rounded-2xl p-8 h-full transition-all duration-300 hover:bg-muted hover:shadow-lg hover:transform hover:translate-y-[-4px]">
                  {/* Icon */}
