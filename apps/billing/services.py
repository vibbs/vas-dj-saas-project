...
class StripeService:
    ...
    @staticmethod
    def create_checkout_session(plan: Plan, account, success_url: str, cancel_url: str, organization=None):
        try:
    ...
    def sync_invoice_from_stripe(stripe_invoice_id: str):
        try:
            ...
            if stripe_invoice.status_transitions and stripe_invoice.status_transitions.get('paid_at'):
